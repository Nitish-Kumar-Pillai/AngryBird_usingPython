...
def sling_action():
    ...
    # sling_x,sling_y ->default position for sling where bird rests
...
class main():
    def _init_(self,distance,angle,pos,space,bird_list):
        self.distance = distance
        self.angle = angle
        self.pos = pos
        self.space = space

        bird = Bird(distance,angle,pos.x,pos.y,space)
        bird1 = Bird(distance, angle, pos.x, pos.y, space)
        bird2 = Bird(distance, angle, pos.x, pos.y, space)
        bird3 = Bird(distance, angle, pos.x, pos.y, space)

        bird_list.append(bird)
        bird_list.append(bird1)
        bird_list.append(bird2)
        bird_list.append(bird3)

    def draw_bird(self,bird_list):
...
while running:
    ...
    pygame.display.flip()
    clock.tick(50)
    pygame.display.set_caption("MINOR PROJECT 2")
